...
return [
    ...
    'incidents_perpetrator' => [
        'title'                    => 'Виновники инциндентов',
        'incidents_perpetrator'    => 'Виновник инцидента',
        'logged'                   => '{0} Нет инцидентов, отличная работа!|У вас зарегистрирован <strong>:count</strong> инцидент.|У вас зарегистрировано <strong>:count</strong> инцидента.|У вас зарегистрировано <strong>:count</strong> инцидентов.',
        'incident-create-template' => 'Создать шаблон',
        'incident-templates'       => 'Шаблоны инцидентов',
        'updates'                  => '{0} Zero Updates|One Update|:count Updates',
        'add'                      => [
            'title'   => 'Добавить виновника инцидента',
            'success' => 'Виновник инциндента добавлен.',
            'failure' => 'При добавлении виновника инцидента произошла ошибка, пожалуйста, попробуйте ещё раз.',
        ],
        'edit' => [
            'title'   => 'Изменить виновника инцидента',
            'success' => 'Виновник инциндента обновлен.',
            'failure' => 'При редактировании Виновник инциндента произошла ошибка, пожалуйста, попробуйте ещё раз.',
        ],
        'delete' => [
            'success' => 'Виновник инциндента удалён и больше не будет отображаться на статусной странице.',
            'failure' => 'Инцидент не может быть уделён, пожалуйста, попробуйте ещё раз.',
        ],
        'update' => [
            'title'    => 'Create new incident update',
